...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f0ede6]">
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <h1 className="font-display leading-none mb-6">
            <span className="block text-6xl md:text-8xl text-[#f0ede6] tracking-wider">THE JUSTO'S</span>
            <span className="block text-6xl md:text-8xl text-brand-orange tracking-wider">MIXTAPE</span>
            <span className="block text-6xl md:text-8xl text-[#f0ede6] tracking-wider">AWARDS</span>
          </h1>
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="w-[280px] h-[280px] rounded-full bg-[#0d0d0d] border-2 border-dashed border-brand-orange flex items-center justify-center">
      ...
      <section className="border-y border-[#1e1e1e] bg-[#0d0d0d]">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center justify-center py-10 border-r border-[#1e1e1e] last:border-r-0"
            >
              <span className="font-display text-[44px] text-brand-orange leading-none">{stat.number}</span>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          {YEARS.map((year) => (
            <button
              ...
              className={`font-mono text-sm tracking-widest px-4 py-2 border transition-colors ${
                selectedYear === year
      ...
      {/* ── MERCH ── */}
      <section className="bg-[#0d0d0d] border-y border-[#1e1e1e] px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {MERCH.map((item, i) => (
              <div key={i} className="border border-[#1e1e1e] bg-[#0a0a0a]">
                <div className="h-48 bg-[#111111] flex items-center justify-center border-b border-[#1e1e1e]">
                  <span className="font-mono text-xs text-[#888888] tracking-widest">[ Product Image ]</span>
                </div>
                <div className="p-5">
      ...
      {/* ── LEADERSHIP ── */}
      <section className="px-6 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        <div>
      ...
      {/* ── STORY ── */}
      <section className="border-t border-[#1e1e1e] px-6 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="font-display text-5xl text-[#f0ede6] tracking-wider leading-tight mb-6">
